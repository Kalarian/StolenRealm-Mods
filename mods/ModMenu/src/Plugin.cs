...
namespace ModMenu
{
    ...
    public class ModMenuPlugin : BaseUnityPlugin
    {
        ...
        internal static ModMenuConfig Cfg;
        ...
        {
            if (_patched) return;
            Type[] containers = { typeof(MenuPatches) };
        ...
        private void Update()
        {
            if (_patched) { try { MenuWindow.Tick(); } catch (Exception e) { if (Cfg != null && Cfg.Verbose.Value) Log.LogWarning("Tick: " + e); } }
