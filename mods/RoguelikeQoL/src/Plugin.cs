...
using HarmonyLib;
using RoguelikeQoL.Patches;

namespace RoguelikeQoL
{
    [BepInPlugin(PluginInfo.PLUGIN_GUID, PluginInfo.PLUGIN_NAME, PluginInfo.PLUGIN_VERSION)]
    public class RoguelikeQoLPlugin : BaseUnityPlugin
    {
        internal static ManualLogSource Log;
        internal static RoguelikeQoLConfig Cfg;
        ...
        private void Awake()
        {
            ...
            Cfg = new RoguelikeQoLConfig(Config);
        ...
        {
            if (_patched) return;
            Type[] containers = { typeof(EventPatches), typeof(CurrencyPatches), typeof(RarityPatches) };
