...
using HarmonyLib;
using LevelSync.Patches;

namespace LevelSync
{
    [BepInPlugin(PluginInfo.PLUGIN_GUID, PluginInfo.PLUGIN_NAME, PluginInfo.PLUGIN_VERSION)]
    public class LevelSyncPlugin : BaseUnityPlugin
    {
        internal static ManualLogSource Log;
        internal static LevelSyncConfig Cfg;
        internal static LevelPool Pool;
        ...
        private void Awake()
        {
            ...
            Cfg = new LevelSyncConfig(Config);
            Pool = new LevelPool();
        ...
        {
            if (_patched) return;
            Type[] containers = { typeof(LevelPatches) };
        ...
        private void Update()
        {
            if (_patched) { try { LevelPatches.Tick(); } catch { } }
