...
using HarmonyLib;
using SharedFortunes.Patches;

namespace SharedFortunes
{
    [BepInPlugin(PluginInfo.PLUGIN_GUID, PluginInfo.PLUGIN_NAME, PluginInfo.PLUGIN_VERSION)]
    public class SharedFortunesPlugin : BaseUnityPlugin
    {
        internal static ManualLogSource Log;
        internal static SharedFortunesConfig Cfg;
        internal static FortunePool Pool;
        ...
        private void Awake()
        {
            ...
            Cfg = new SharedFortunesConfig(Config);
            Pool = new FortunePool();
        ...
        {
            if (_patched) return;
            Type[] containers = { typeof(FortunePatches) };
        ...
        private void Update()
        {
            if (_patched) { try { FortunePatches.Tick(); } catch { } }
