...
using HarmonyLib;
using FortunePreview.Patches;

namespace FortunePreview
{
    [BepInPlugin(PluginInfo.PLUGIN_GUID, PluginInfo.PLUGIN_NAME, PluginInfo.PLUGIN_VERSION)]
    public class FortunePreviewPlugin : BaseUnityPlugin
    {
        internal static ManualLogSource Log;
        internal static FortunePreviewConfig Cfg;
        ...
        private void Awake()
        {
            ...
            Cfg = new FortunePreviewConfig(Config);
        ...
        {
            if (_patched) return;
            Type[] containers = { typeof(QuestTooltipPatches), typeof(EventOptionPatches), typeof(FortuneTooltipPatches), typeof(FortuneWindowPatches) };
        ...
        private void Update()
        {
            if (_patched) { try { QuestTooltipPatches.Tick(); } catch { } }
