...
using HarmonyLib;
using TargetTooltip.Patches;

namespace TargetTooltip
{
    [BepInPlugin(PluginInfo.PLUGIN_GUID, PluginInfo.PLUGIN_NAME, PluginInfo.PLUGIN_VERSION)]
    public class TargetTooltipPlugin : BaseUnityPlugin
    {
        internal static ManualLogSource Log;
        internal static TargetTooltipConfig Cfg;
        ...
        private void Awake()
        {
            ...
            Cfg = new TargetTooltipConfig(Config);
        ...
        {
            if (_patched) return;
            Type[] containers = { typeof(HoverTooltipPatches) };
        ...
        {
            if (!_patched) return;
            HoverTooltipPatches.RestoreTooltipVisuals();
        ...
        private void Update()
        {
            if (_patched && Cfg != null && Cfg.StyleToggleKey.Value.IsDown())
            {
