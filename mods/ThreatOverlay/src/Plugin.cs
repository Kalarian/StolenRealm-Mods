...
using HarmonyLib;
using ThreatOverlay.Patches;

namespace ThreatOverlay
{
    [BepInPlugin(PluginInfo.PLUGIN_GUID, PluginInfo.PLUGIN_NAME, PluginInfo.PLUGIN_VERSION)]
    public class ThreatOverlayPlugin : BaseUnityPlugin
    {
        internal static ManualLogSource Log;
        internal static ThreatOverlayConfig Cfg;
        ...
        private void Awake()
        {
            ...
            Cfg = new ThreatOverlayConfig(Config);
        ...
        {
            if (_patched) return;
            Type[] containers = { typeof(OverlayPatches) };
        ...
        private void Update()
        {
            if (_patched) { try { OverlayPatches.Tick(); } catch { } }
