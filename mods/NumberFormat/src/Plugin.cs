...
using HarmonyLib;
using NumberFormat.Patches;

namespace NumberFormat
{
    [BepInPlugin(PluginInfo.PLUGIN_GUID, PluginInfo.PLUGIN_NAME, PluginInfo.PLUGIN_VERSION)]
    public class NumberFormatPlugin : BaseUnityPlugin
    {
        internal static ManualLogSource Log;
        internal static NumberFormatConfig Cfg;
        ...
        private void Awake()
        {
            ...
            Cfg = new NumberFormatConfig(Config);
        ...
        {
            if (_patched) return;
            Type[] containers = { typeof(NumberPatches) };
