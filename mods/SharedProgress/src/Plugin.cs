...
using HarmonyLib;
using SharedProgress.Patches;

namespace SharedProgress
{
    [BepInPlugin(PluginInfo.PLUGIN_GUID, PluginInfo.PLUGIN_NAME, PluginInfo.PLUGIN_VERSION)]
    public class SharedProgressPlugin : BaseUnityPlugin
    {
        internal static ManualLogSource Log;
        internal static SharedProgressConfig Cfg;
        internal static ProgressPool Pool;
        ...
        private void Awake()
        {
            ...
            Cfg = new SharedProgressConfig(Config);
        ...
        {
            if (_patched) return;
            Type[] containers = { typeof(ProgressPatches) };
        ...
        private void Update()
        {
            if (_patched) { try { ProgressPatches.Tick(); } catch { } }
