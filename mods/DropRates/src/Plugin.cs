...
using HarmonyLib;
using DropRates.Patches;

namespace DropRates
{
    [BepInPlugin(PluginInfo.PLUGIN_GUID, PluginInfo.PLUGIN_NAME, PluginInfo.PLUGIN_VERSION)]
    public class DropRatesPlugin : BaseUnityPlugin
    {
        internal static ManualLogSource Log;
        internal static DropRatesConfig Cfg;
        ...
        private void Awake()
        {
            ...
            Cfg = new DropRatesConfig(Config);
        ...
        {
            if (_patched) return;
            Type[] containers = { typeof(EnemyContextPatches), typeof(WorldLootPatches), typeof(PersonalLootPatches), typeof(MerchantPatches), typeof(TownShopPatches), typeof(GamblingPatches) };
