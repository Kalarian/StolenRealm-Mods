...
using HarmonyLib;
using ItemSkillTooltips.Patches;

namespace ItemSkillTooltips
{
    [BepInPlugin(PluginInfo.PLUGIN_GUID, PluginInfo.PLUGIN_NAME, PluginInfo.PLUGIN_VERSION)]
    public class ItemSkillTooltipsPlugin : BaseUnityPlugin
    {
        internal static ManualLogSource Log;
        internal static ItemSkillTooltipsConfig Cfg;
        ...
        private void Awake()
        {
            ...
            Cfg = new ItemSkillTooltipsConfig(Config);
        ...
        {
            if (_patched) return;
            Type[] containers = { typeof(ItemSkillPatches) };
