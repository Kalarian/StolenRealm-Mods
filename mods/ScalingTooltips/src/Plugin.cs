...
using HarmonyLib;
using ScalingTooltips.Patches;

namespace ScalingTooltips
{
    [BepInPlugin(PluginInfo.PLUGIN_GUID, PluginInfo.PLUGIN_NAME, PluginInfo.PLUGIN_VERSION)]
    public class ScalingTooltipsPlugin : BaseUnityPlugin
    {
        internal static ManualLogSource Log;
        internal static ScalingTooltipsConfig Cfg;
        ...
        private void Awake()
        {
            ...
            Cfg = new ScalingTooltipsConfig(Config);
        ...
        {
            if (_patched) return;
            Type[] containers = { typeof(ScalingPatches) };
